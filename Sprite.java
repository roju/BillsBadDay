...
public class Sprite extends Object {
    ...
    public double speedY() { return currentSpeedY; }
    public void setSpeedY(double speedY) { currentSpeedY = speedY; }

    public double speedX() { return currentSpeedX; }
    public void setSpeedX(double speedX) { currentSpeedX = speedX; }

    public double health() { return currentHealth; }
    public void setHealth(double health) { currentHealth = health; }

    public double maxHealth() { return currentMaxHealth; }
    public void setMaxHealth(double health) { currentMaxHealth = health; }
