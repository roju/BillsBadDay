...
public class GalacticWar extends Game1 {
//these must be static because they are passed to a constructor
static int FRAMERATE = 60;
static int SCREENWIDTH = 1200;
static int SCREENHEIGHT = 700;
//misc global constants
final int ASTEROIDS = 1;//10
final int BULLET_SPEED = 5;//4
//final double ACCELERATION = 0.1;// already in Game class
...
boolean keyLeft, keyRight, keyUp, keyDown, keyFire, keyB, keyC, keyShield;
...
g2d.drawString("GALACTIC WAR", 402, 202);
g2d.setColor(new Color(200,30,30));
g2d.drawString("GALACTIC WAR", 400, 200);
int x = 420, y = 14;
...
g2d.drawString("THRUST - Up/Down Arrow", x+20, ++y*20);
g2d.drawString("SHIELD - Shift Key (no scoring)", x+20, ++y*20);
g2d.drawString("FIRE - Ctrl Key", x+20, ++y*20);
g2d.drawString("AUTOFIRE ON/OFF - A Key", x+20, ++y*20);
g2d.drawString("MOUSE CONTROL ON/OFF - M Key", x+20, ++y*20);
g2d.drawString("BACKGROUND ON/OFF - Q Key", x+20, ++y*20);
g2d.drawString(" ", x+20, ++y*20); // blank line
g2d.setColor(Color.WHITE);
g2d.drawString("POWERUPS INCREASE FIREPOWER!", x+20, ++y*20);
g2d.setFont(new Font("Ariel", Font.BOLD, 24));
g2d.setColor(Color.ORANGE);
g2d.drawString("Press ENTER to start", 450, 570);
}
...
g2d.setColor(Color.WHITE);
g2d.drawString("Position: X:"+movex+" Y:"+movey, 20, 20);

if(mCont){g2d.drawLine((int)shipX,(int)shipY,(int)movex,(int)movey);}
...
case SPRITE_SHIP:
warp(sprite);
shipX=sprite.center().X();
shipY=sprite.center().Y();
if(mCont){mouseControl(sprite);}
